...
export const ui = {
  pl: {
    ...
    'nav.product.boarding': 'Pensjonat',
    'nav.product.feed': 'Pasza i żywienie',
    'nav.for': 'Dla kogo',
  ...
  en: {
    ...
    'nav.product.boarding': 'Boarding',
    'nav.product.feed': 'Feed & nutrition',
    'nav.for': 'Solutions',
  ...
  de: {
    ...
    'nav.product.boarding': 'Pensionsstall',
    'nav.product.feed': 'Futter & Ernährung',
    'nav.for': 'Für wen',
  ...
  fr: {
    ...
    'nav.product.boarding': 'Pension',
    'nav.product.feed': 'Alimentation',
    'nav.for': 'Solutions',
